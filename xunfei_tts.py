...
APPID = '38f96114'  # 替换为你的APPID
APIKEY = '98856505f9fc763f9e31187a772ba28b'  # 替换为你的APIKey
APISECRET = 'NGM5ZDI3OWYzYjFiNTE3NDhjNmZjMmNj'  # 替换为你的APISecret
...
class Ws_Param(object):
    def __init__(self, APPID, APIKey, APISecret, Text):
        ...
        self.BusinessArgs = {
            "tts": {
                "vcn": "x5_lingxiaoyue_flow", # 语音合成模型，可参考 https://www.xfyun.cn/services/smart-tts
                "volume": 50, # 音量
                "rhy": 1, # 韵律
                "speed": 50, # 语速
                "pitch": 50, # 语调
